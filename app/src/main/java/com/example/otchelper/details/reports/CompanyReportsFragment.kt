...
class CompanyReportsFragment : SimpleFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.vpInfo.adapter =
            ReportsViewPagerAdapter(requireContext(), childFragmentManager, stockNotNull)
    ...
    companion object {
        ...
        fun newInstance(stock: DomainStock): CompanyReportsFragment =
            CompanyReportsFragment().apply {
