...
class BiggestChartView @JvmOverloads constructor(
    ...
    init {
        inflate(context, R.layout.view_historical_chart_biggest, this)
    ...
    private fun initCharts() {
        ...
        with(volumeChart) {
            ...
            yRightAxis.maxWidth = CompaniesBinding.dpToPixels(context, 20f)
            yRightAxis.minWidth = CompaniesBinding.dpToPixels(context, 20f)
            yRightAxis.textSize = CompaniesBinding.spToPixels(context, 4f)
