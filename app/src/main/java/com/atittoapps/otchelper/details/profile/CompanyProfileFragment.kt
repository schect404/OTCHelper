package com.atittoapps.otchelper.details.profile
...
import com.atittoapps.otchelper.common.toInfoList
...
class CompanyProfileFragment : SimpleFragment() {
    ...
    companion object {
        ...
        fun newInstance(stock: DomainStock): CompanyProfileFragment =
            CompanyProfileFragment().apply {
