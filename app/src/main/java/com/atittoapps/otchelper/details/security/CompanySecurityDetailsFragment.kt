package com.atittoapps.otchelper.details.security
...
import com.atittoapps.otchelper.common.toSecuritiesList
...
class CompanySecurityDetailsFragment : SimpleFragment() {
    ...
    companion object {
        ...
        fun newInstance(stock: DomainStock): CompanySecurityDetailsFragment =
            CompanySecurityDetailsFragment().apply {
